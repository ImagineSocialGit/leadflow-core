...
class FinalizeCompletedWebinarJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(
        ...
        ResolveWebinarPlaybackAction $resolveWebinarPlaybackAction,
        ...
        if (! $resolveWebinarPlaybackAction->execute($provider, $webinar)) {
            $this->release(300);
